...
const PlasmoniAIAgent = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-3 sm:p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-3 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-600">Advanced Water Treatment Design</p>
              </div>
            </div>
            <button
              onClick={() => setResult(null)}
              className="flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-white border-2 border-gray-200 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all font-semibold text-gray-700 shadow-sm text-sm sm:text-base w-full sm:w-auto justify-center"
            >
          ...
          {/* Confidence Banner - Responsive */}
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl border-2 border-blue-100 p-4 sm:p-6 mb-4 sm:mb-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className={`${getConfidenceColor(result.confidence)} w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0`}>
                  <CheckCircle2 className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                </div>
                <div>
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Analysis Complete</h2>
                  <p className="text-sm sm:text-base text-gray-600">Match: <span className="font-semibold text-blue-600">{result.matchType.replace('_', ' ').toUpperCase()}</span></p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              {/* Optimal Design Parameters - Responsive Grid */}
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl border-2 border-blue-100 p-4 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {Object.entries(result.design).map(([key, value]) => (
                    <div key={key} className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-blue-200">
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl border-2 border-purple-100 p-4 sm:p-6">
                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                  {Object.entries(result.performance).map(([key, value]) => {
                    ...
                    return (
                      <div key={key} className={`rounded-lg sm:rounded-xl p-3 sm:p-4 border-2 ${isHighPerformance ? 'bg-gradient-to-br from-emerald-50 to-green-50 border-emerald-200' : 'bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200'}`}>
                        {isHighPerformance && (
              ...
              {result.aiAnalysis && (
                <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 text-white">
                  <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
            ...
            {/* Right Column - Additional Info - Responsive */}
            <div className="space-y-4 sm:space-y-6">
              {/* Input Summary - Responsive */}
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl border-2 border-gray-100 p-4 sm:p-6">
                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-gray-500 to-gray-700 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <button className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-xl sm:rounded-2xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-2xl flex items-center justify-center gap-2 sm:gap-3 shadow-xl text-sm sm:text-base">
          ...
          <div className="text-center mt-6 sm:mt-8">
            <p className="text-xs sm:text-sm text-gray-500 flex items-center justify-center gap-2 flex-wrap">
              ...
              <span>Powered by GPT-4 AI · Plasmonic Ophiolite Intelligence</span>
            </p>
          </div>
        </div>
      </div>
  ...
  // Form View - Improved Responsiveness
  return (
      ...
      <div className="max-w-6xl mx-auto p-3 sm:p-4 md:p-8">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-12">
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-2xl flex-shrink-0">
        ...
        {error && (
          <div className="bg-red-50 border-2 border-red-200 rounded-xl sm:rounded-2xl p-3 sm:p-4 mb-4 sm:mb-6 flex items-start gap-2 sm:gap-3">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl border-2 border-blue-100 p-4 sm:p-6 md:p-8">
          {/* Basic Parameters - Responsive Grid */}
          ...
          {/* Operational Parameters - Responsive Grid */}
          <div className="mb-6 sm:mb-8">
            <h3 className="text-base sm:text-lg font-bold text-gray-800 mb-3 sm:mb-4 flex items-center gap-2">
